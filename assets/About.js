            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 order-lg-1 pe-4">
                    <div class="row-md-10 mb-4">
                        ...
                        <p class="mb-2 text-4 text-justify text-color-grey"><a className="text-color-secondary" href="https://www.linkedin.com/in/jonathan-trousdale/">Jonathan Trousdale</a> is an engineer, patent attorney and entrepreneur.
                ...
                <div class="col-lg-2 order-lg-2">
                    <aside class="sidebar">
                        ...
                        <ul class="list list-icons list-borders list-secondary">
                            <li> <i class="fa fa-caret-right color"></i>  <a className="text-color-secondary text-4" href="translations.html">Translations</a></li>
                            <li> <i class="fa fa-caret-right color"></i>  <a className="text-color-secondary text-4" href="https://github.com/DeltaBar">GitHub</a></li>
                            <li> <i class="fa fa-caret-right color"></i>  <a className="text-color-secondary text-4" href="contact.html">Subscribe to Updates</a></li>
                        </ul>
                    </aside>
                </div>
            </div>
